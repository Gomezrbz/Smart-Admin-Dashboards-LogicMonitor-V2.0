...
| `dashboard-redesign/dashboards/executive/10_Executive_Command_Center_redesign_v2.json` | 10 - Executive Command Center | Executive | OK | 21 | **pass** |  |
| `dashboard-redesign/dashboards/executive/11_Platform_Value_Overview_redesign_v2.json` | 11 - Platform Value Overview | Executive | OK | 22 | **pass** |  |
| `dashboard-redesign/dashboards/executive/12_Environment_Health_Executive_redesign_v2.json` | 12 - Environment Health Executive | Executive | OK | 18 | **pass** |  |
...
| `dashboard-redesign/dashboards/operational/20_Operational_Command_Center_redesign_v2.json` | 20 - Operational Command Center | Operational | OK | 18 | **pass** |  |
| `dashboard-redesign/dashboards/operational/21_Active_Alerts_redesign_v2.json` | 21 - Active Alerts | Operational | OK | 24 | **pass** |  |
| `dashboard-redesign/dashboards/operational/22_Resource_Health_redesign_v2.json` | 22 - Resource Health | Operational | OK | 20 | **pass** |  |
...
| `dashboard-redesign/dashboards/operational/25_Access_and_Administration_redesign_v2.json` | 25 - Access and Administration | Operational | OK | 18 | **pass** |  |
...
| `dashboard-redesign/dashboards/technical/31_Collector_Diagnostics_redesign_v2.json` | 31 - Collector Diagnostics | Technical | OK | 35 | **pass** |  |
| `dashboard-redesign/dashboards/technical/32_LogicModule_and_Content_redesign_v2.json` | 32 - LogicModule and Content | Technical | OK | 18 | **pass** |  |
| `dashboard-redesign/dashboards/technical/33_Adoption_and_Optimization_redesign_v2.json` | 33 - Adoption and Optimization | Technical | OK | 17 | **pass** |  |
...
- **Placeholders:** `['{{ACCOUNT_NAME}}', '{{DASHBOARD_ID_10}}', '{{DASHBOARD_ID_11}}', '{{DASHBOARD_ID_20}}', '{{DASHBOARD_ID_21}}', '{{DASHBOARD_ID_30}}', '{{DASHBOARD_ID_34}}', '{{OOTB_ALERTING_ID}}', '{{OOTB_CAPACITY_ID}}', '{{OOTB_CLOUD_ID}}', '{{OOTB_NETWORK_ID}}', '{{OOTB_SERVER_ID}}', '{{OOTB_STORAGE_ID}}', '{{OOTB_VIRT_ID}}', '{{OOTB_WEBSITES_ID}}', '{{PORTAL_BASE}}']`
- **Overlaps:** none
...
- **Placeholders:** `['{{DASHBOARD_ID_10}}', '{{DASHBOARD_ID_21}}', '{{DASHBOARD_ID_23}}', '{{DASHBOARD_ID_34}}', '{{PORTAL_BASE}}']`
- **Overlaps:** none
- **Script tags in text:** none
...
- **Placeholders:** `['{{OOTB_ALERTING_ID}}', '{{OOTB_CAPACITY_ID}}', '{{OOTB_CLOUD_ID}}', '{{OOTB_NETWORK_ID}}', '{{OOTB_SERVER_ID}}', '{{OOTB_STORAGE_ID}}', '{{OOTB_VIRT_ID}}', '{{OOTB_WEBSITES_ID}}', '{{PORTAL_BASE}}']`
- **Overlaps:** none
- **Script tags in text:** none
...
- **Placeholders:** `['{{ACCOUNT_NAME}}', '{{DASHBOARD_ID_10}}', '{{DASHBOARD_ID_11}}', '{{DASHBOARD_ID_20}}', '{{DASHBOARD_ID_21}}', '{{DASHBOARD_ID_22}}', '{{DASHBOARD_ID_23}}', '{{DASHBOARD_ID_30}}', '{{DASHBOARD_ID_31}}', '{{DASHBOARD_ID_32}}', '{{DASHBOARD_ID_33}}', '{{DASHBOARD_ID_34}}', '{{OOTB_ALERTING_ID}}', '{{OOTB_CAPACITY_ID}}', '{{OOTB_CLOUD_ID}}', '{{OOTB_NETWORK_ID}}', '{{OOTB_SERVER_ID}}', '{{OOTB_STORAGE_ID}}', '{{OOTB_VIRT_ID}}', '{{OOTB_WEBSITES_ID}}', '{{PORTAL_BASE}}']`
- **Overlaps:** none
- **Script tags in text:** none
- **Link validation:** Placeholders only — **portal testing required** for live URLs
- **HTML validation:** Static HTML/CSS only (no script tags allowed in core pack)
...
- **Tokens:** `[('defaultResource', '*.logicmonitor.com'), ('defaultResourceGroup', '*')]`
- **Placeholders:** `['{{DASHBOARD_ID_21}}', '{{DASHBOARD_ID_22}}', '{{DASHBOARD_ID_31}}', '{{DASHBOARD_ID_32}}', '{{DASHBOARD_ID_33}}', '{{DASHBOARD_ID_34}}', '{{PORTAL_BASE}}']`
- **Overlaps:** none
- **Script tags in text:** none
